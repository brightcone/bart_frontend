...
const Agent = () => {
    ...
    const [hasSentVerificationMessage, setHasSentVerificationMessage] = useState(false); // New state to track if message was sent
    ...
    const handleAuthComplete = () => {
        ...
        setHasSentVerificationMessage(prevState => {
            if (!prevState) {
        ...
        try {
            ...
            try {
                ...
                if (response.completion) {
                    ...
                    const isOptionMessage = fullResponse.includes("Which application do you want to change the password for?") || fullResponse.includes("Can you please provide me with the following details? - Application for which the password needs to be changed");
                    ...
                    const isVideoVerificationMessage = fullResponse.includes("Please complete video verification before proceeding.");
